...
func TestValidateFieldAlign(t *testing.T) {
	expectNoErrors(t, validateWrapped(t, `<field name="model" align="left"/>`))
	expectNoErrors(t, validateWrapped(t, `<field name="model" align="right"/>`))
	expectNoErrors(t, validateWrapped(t, `<field name="model"/>`))
	expectError(t, validateWrapped(t, `<field name="model" align="center"/>`), "align")
}
