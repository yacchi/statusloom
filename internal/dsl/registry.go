...
// (markup.md "メトリクス名"): the 14 existing metrics plus the
// newly-introduced "git-dirty" boolean (markup.md 付録).
var claudeCodeMetrics = []MetricDef{
	{Name: "compaction-count", DisplayName: "Compactions"}, {Name: "compaction-auto", DisplayName: "Automatic Compactions"}, {Name: "compaction-manual", DisplayName: "Manual Compactions"}, {Name: "compaction-unknown", DisplayName: "Unknown Compactions"}, {Name: "compaction-tokens-reclaimed", DisplayName: "Reclaimed Tokens"},
	{Name: "session-input-tokens", DisplayName: "Session Input Tokens"}, {Name: "session-output-tokens", DisplayName: "Session Output Tokens"}, {Name: "session-cache-creation-tokens", DisplayName: "Session Cache Creation Tokens"}, {Name: "session-cache-read-tokens", DisplayName: "Session Cache Read Tokens"}, {Name: "session-total-tokens", DisplayName: "Session Total Tokens"},
	{Name: "input-token-speed", DisplayName: "Input Token Speed"}, {Name: "output-token-speed", DisplayName: "Output Token Speed"}, {Name: "total-token-speed", DisplayName: "Total Token Speed"},
...
// toolCatalogs is keyed by the `tool` root attribute value. Only
// "claude-code" exists today; unknown tools yield zero values / false
// from every lookup function below.
