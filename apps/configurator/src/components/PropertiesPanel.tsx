...
import { ThresholdBar } from "./ThresholdBar.tsx";
...
function ColorRulesSection({
    ...
    const showBar = canBar && !preferAdvanced;
            ...
            <div className="field">
                ...
                {showBar ? (
                    <button
                        ...
                        data-testid="colorrule-mode-advanced"
                        onClick={() => setPreferAdvanced(true)}
                    >
                        {t(lang, "colorRulesAdvanced")}
                    </button>
                ) : canBar ? (
                    <button
                        className="link-button"
                        data-testid="colorrule-mode-bar"
                        onClick={() => setPreferAdvanced(false)}
                    >
                        {t(lang, "colorRulesBar")}
                    </button>
                ) : null}
            </div>
